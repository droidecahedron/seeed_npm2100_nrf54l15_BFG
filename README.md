...
<p align="center">
  ...
  This is the sequel to the original <a href="https://github.com/droidecahedron/npm2100_nrf54l15_BFG" target="_blank">BFG Demo</a>. This demo does NOT have DLE/mtu exchange/connection parameter negotiation or ADC features like the previous demo. If you need/want any of those features, please refer to the previous demo.
...
Entering ship mode will terminate any active BLE connection.
